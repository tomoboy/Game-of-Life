This project is an implementation of [Conway's Game of Life](https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life) using React with Material-UI.
I made this just for fun to get some practice with React.
